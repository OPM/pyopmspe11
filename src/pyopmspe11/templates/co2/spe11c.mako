...
% if dic['inj'][j][3+3*i] > 0:
${dic['wellijk'][i][0]} ${dic['wellijk'][i][1]+k} ${dic['wellijk'][i][2] if i==0 else dic['wellkh'][k]} GAS ${f"{dic['inj'][j][4+3*i] * 86400. / (1+dic['wellijkf'][i][1]-dic['wellijk'][i][1]):E}"} ${f"{-dic['inj'][j][4+3*i] * 86400. * (273.15 + dic['inj'][j][5+3*i]) * 1.009 / (1+dic['wellijkf'][i][1]-dic['wellijk'][i][1]):E}"} /
% else:
${dic['wellijk'][i][0]} ${dic['wellijk'][i][1]+k} ${dic['wellijk'][i][2] if i==0 else dic['wellkh'][k]} ${'WATER' if dic['co2store'] == 'gaswater' else 'OIL'} ${f"{dic['inj'][j][4+3*i] * 86400. / (1+dic['wellijkf'][i][1]-dic['wellijk'][i][1]):E}"} ${f"{-dic['inj'][j][4+3*i] * 86400. * (273.15 + dic['inj'][j][5+3*i]) * 0.085 / (1+dic['wellijkf'][i][1]-dic['wellijk'][i][1]):E}"} /
% endif
% endfor
% endif
% endfor
